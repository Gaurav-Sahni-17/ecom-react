...
import dispatchByCity from "../../controllers/ordermanagement/dispatchbycity.js";
export default function City() {
    ...
    useEffect(() => {
        if (user.username) {
            fetch("http://localhost:3000/dispatchordersofcity", {
                method: "POST",
    ...
    function accept(element) {
        return function () {
            acceptOrder({ id: element.order_id, status: "Arrived City Terminal" }).then(() => {
                swal.fire({
